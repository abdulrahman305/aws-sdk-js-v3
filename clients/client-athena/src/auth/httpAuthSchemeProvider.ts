...
import { AthenaClientConfig, AthenaClientResolvedConfig } from "../AthenaClient";
 ...
 * @internal
 */
export const defaultAthenaHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AthenaHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAthenaHttpAuthSchemeProvider: AthenaHttpAuthSchemeProvider = (authParameters) => {
