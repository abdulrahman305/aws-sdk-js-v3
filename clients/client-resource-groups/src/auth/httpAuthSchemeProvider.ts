...
import { ResourceGroupsClientConfig, ResourceGroupsClientResolvedConfig } from "../ResourceGroupsClient";
 ...
 * @internal
 */
export const defaultResourceGroupsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ResourceGroupsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultResourceGroupsHttpAuthSchemeProvider: ResourceGroupsHttpAuthSchemeProvider = (authParameters) => {
