...
import { AuditManagerClientConfig, AuditManagerClientResolvedConfig } from "../AuditManagerClient";
 ...
 * @internal
 */
export const defaultAuditManagerHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AuditManagerHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAuditManagerHttpAuthSchemeProvider: AuditManagerHttpAuthSchemeProvider = (authParameters) => {
