 ...
 * @public
 */
export type ArtifactClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type ArtifactClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getIdentityProviderConfigProvider() {
    return async (config: ArtifactClientResolvedConfig) =>
