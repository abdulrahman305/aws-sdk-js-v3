...
import { CodeBuildClientConfig, CodeBuildClientResolvedConfig } from "../CodeBuildClient";
 ...
 * @internal
 */
export const defaultCodeBuildHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CodeBuildHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: CodeBuildClientConfig, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCodeBuildHttpAuthSchemeProvider: CodeBuildHttpAuthSchemeProvider = (authParameters) => {
