...
import {
  defaultMediaPackageHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type MediaPackageClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type MediaPackageClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getIdentityProviderConfigProvider() {
    return async (config: MediaPackageClientResolvedConfig) =>
