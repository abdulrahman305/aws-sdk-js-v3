...
import { ElastiCacheClientConfig, ElastiCacheClientResolvedConfig } from "../ElastiCacheClient";
 ...
 * @internal
 */
export const defaultElastiCacheHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ElastiCacheHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultElastiCacheHttpAuthSchemeProvider: ElastiCacheHttpAuthSchemeProvider = (authParameters) => {
