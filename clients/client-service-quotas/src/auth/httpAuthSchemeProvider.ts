...
import { ServiceQuotasClientConfig, ServiceQuotasClientResolvedConfig } from "../ServiceQuotasClient";
 ...
 * @internal
 */
export const defaultServiceQuotasHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ServiceQuotasHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultServiceQuotasHttpAuthSchemeProvider: ServiceQuotasHttpAuthSchemeProvider = (authParameters) => {
