...
import { XRayClientConfig, XRayClientResolvedConfig } from "../XRayClient";
 ...
 * @internal
 */
export const defaultXRayHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: XRayHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultXRayHttpAuthSchemeProvider: XRayHttpAuthSchemeProvider = (authParameters) => {
