...
import { AppflowClientConfig, AppflowClientResolvedConfig } from "../AppflowClient";
 ...
 * @internal
 */
export const defaultAppflowHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppflowHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAppflowHttpAuthSchemeProvider: AppflowHttpAuthSchemeProvider = (authParameters) => {
